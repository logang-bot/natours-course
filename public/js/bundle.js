      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // The true parameter enforces to reaload from the server and no from browser's cache
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG9nYXRzdSIsImEiOiJjbDByZXBxdzkwMGN4M2RsaGIyaGw1NGtyIn0.lq6qQkFf1T1dFw0rOrXeUQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // console.dir(err);
...
var stripe = Stripe('pk_test_51KeKWvDVNHXpxtEBY6n8XgoZLg3R1jpZs1mWh5Sn9YoBXzpFLCSjWd1b0v8splxRKZuXy2n8l0k5dcGofBNNthwA00wzk4R54Q');
